...
export function EditLanguagesModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (updateError) {
        console.error("EditLanguagesModal: erro ao salvar:", updateError.message);
      ...
      console.error("EditLanguagesModal: falha inesperada ao salvar:", err);
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg max-h-[80vh] flex flex-col rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border)]">
              <h2 className="font-mono text-sm text-[var(--color-text)]">Editar idiomas</h2>
