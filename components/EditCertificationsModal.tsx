...
export function EditCertificationsModal({
  ...
  return (
    <>
      <button
        onClick={handleOpen}
        aria-label="Editar certificados"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-xl max-h-[85vh] flex flex-col rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border)]">
              <h2 className="font-mono text-sm text-[var(--color-text)]">Editar certificados</h2>
            ...
            <div className="overflow-y-auto px-5 py-4 space-y-5">
              {entries.map((entry, i) => (
                <div key={i} className="rounded-lg border border-[var(--color-border)] p-4 space-y-3 relative">
                  ...
                  <div>
                    <label className="text-xs font-mono text-[var(--color-text-faint)]">Nome do certificado</label>
                    <input
                      type="text"
                      value={entry.name}
                  ...
                  <div>
                    <label className="text-xs font-mono text-[var(--color-text-faint)]">Empresa / instituição</label>
                    <input
                      type="text"
                      value={entry.issuer}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs font-mono text-[var(--color-text-faint)]">Emitido em</label>
                    ...
                    <div>
                      <label className="text-xs font-mono text-[var(--color-text-faint)]">Vencimento</label>
                      <div className="mt-1 flex gap-2">
                        <select
