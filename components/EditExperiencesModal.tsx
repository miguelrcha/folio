        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-xl max-h-[85vh] flex flex-col rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border)]">
              <h2 className="font-mono text-sm text-[var(--color-text)]">Edit experiences</h2>
            ...
            <div className="overflow-y-auto px-5 py-4 space-y-5">
              {entries.map((entry, i) => (
                <div key={i} className="rounded-lg border border-[var(--color-border)] p-4 space-y-3 relative">
                  ...
                  <div>
                    <label className="text-xs font-mono text-[var(--color-text-faint)]">Job title</label>
                    <input
                      type="text"
                      value={entry.title}
                      onChange={(e) => updateEntry(i, { title: e.target.value })}
                      placeholder="E.g. Development Intern"
                  ...
                  <div>
                    <label className="text-xs font-mono text-[var(--color-text-faint)]">Company</label>
                    <input
                      type="text"
                      value={entry.company}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs font-mono text-[var(--color-text-faint)]">Start</label>
                    ...
                    <div>
                      <label className="text-xs font-mono text-[var(--color-text-faint)]">End</label>
                      <div className="mt-1 flex gap-2">
                        <select
                  ...
                  <div>
                    <label className="text-xs font-mono text-[var(--color-text-faint)]">
                      What you did (one line per bullet)
                    </label>
                    <textarea
